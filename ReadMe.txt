...
3. Установить и использовать в проекте .NET Framework 4.6.1;	DONE
4. Размер шрифта так же должен сохраняться в конфигурационный файл;	DONE
5. При загрузке программы в выпадающем списке окна 'fontDialog' 
   должен быть загружен шрифт из 'Settings.ini';		DONE
6. Упаковать часы в установочный файл;
